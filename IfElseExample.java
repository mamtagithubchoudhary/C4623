...
/*input from the user. We first create a new Scanner object by passing System.in as an argument to the constructor. This sets up the scanner to read input from the standard input stream, which is usually the keyboard.
